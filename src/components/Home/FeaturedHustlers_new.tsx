...
import { Star, MapPin, Phone, ArrowRight, Crown, Sparkles, Heart } from 'lucide-react';
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div key={hustler.id} className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 transform hover:-translate-y-2">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500/0 to-purple-600/0 group-hover:from-pink-500/10 group-hover:to-purple-600/10 transition-all duration-500 z-10"></div>
              ...
              <div className="relative z-20">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center animate-pulse">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">{hustler.name}</h3>
                  </div>

                  <div className="inline-flex items-center text-sm text-purple-600 bg-purple-100 px-3 py-1 rounded-full mb-4 font-medium">
                  ...
                  <div className="mb-6">
                    <div className="flex flex-wrap gap-2">
                      ...
                      {hustler.services.length > 2 && (
                        <span className="text-xs bg-gradient-to-r from-pink-100 to-purple-100 text-purple-600 px-3 py-1 rounded-full font-medium">
                  ...
                  <div className="flex gap-3">
                    <Link
                      ...
                      className="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 px-4 rounded-xl font-semibold text-center hover:from-pink-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
                      View Profile
                    </Link>
                    <a
        ...
        {/* Call to action */}
        {!loading && featuredHustlers.length > 0 && (
        <div className="text-center mt-16">
          <Link
            to="/hustlers"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-bold rounded-2xl hover:from-pink-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-xl"
          >
            <Sparkles className="mr-2 h-5 w-5" />
            Discover All MSH Entrepreneurs
